"""Train YOLOv10 on the custom vehicle detection dataset."""
...
def train(
    ...
    print(f"Loading YOLOv10 model: {model_variant}")
    ...
    best_path = Path("outputs/training/yolov10_vehicle/weights/best.pt")
    target_path = Path("models/yolov10/best.pt")
    if best_path.exists():
        import shutil
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train YOLOv10 vehicle detector")
